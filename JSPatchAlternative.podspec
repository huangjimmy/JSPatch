Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/huangjimmy/JSPatchAlternative"
  s.license      = { :type => "MIT", :file => "LICENSE" }
  s.author             = { "bang" => "bang590@gmail.com" }
  s.social_media_url   = "http://twitter.com/bang590"

  s.platform     = :ios, "6.0"
  s.source       = { :git => "https://github.com/huangjimmy/JSPatchAlternative.git", :tag => s.version }
